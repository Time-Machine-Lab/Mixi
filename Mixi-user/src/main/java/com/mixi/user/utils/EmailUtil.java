...
public class EmailUtil {
	    ...
	    //发件人邮箱
	    private static String myEmailAccount = "3250162035@qq.com";
	    
	    //发件人邮箱密码（授权码）
	    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
	    private static String myEmailPassword = "ngddqvappbkndbfb";
...
//	        props.put("mail.smtp.ssl.socketFactory", sf);
	...
	public static void send(String mailAddress,String url) throws Exception {

		//邮件主题
		String emailTitle = "邮箱验证";
		//邮件内容
		String emailContent = "请点击链接" + url + "，完成登录，链接5分钟失效！";
		//发送邮件
		EmailUtil.sendEmail(mailAddress, emailTitle, emailContent);
